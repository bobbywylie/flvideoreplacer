var flvideoreplacerListener = {
	...
	onPageLoad: function(aEvent) {
		...
		setTimeout(function () { 
		    ...
		    //declare variables
		    var replacevideo = false, replacemethod, preferwebm, videoelement;
	...
	placeHolder: function(aEvent,aBranch) {
	    ...
	    //get localization
	    var strbundle = document.getElementById("flvideoreplacerstrings");
	    var embedded = strbundle.getString("embedded");
	    var newtab = strbundle.getString("newtab");
	    var newwindow = strbundle.getString("newwindow");
	    var standalone = strbundle.getString("standalone");

	    //parse json
	    jsonObjectLocal = JSON.parse(videodata);
	    //declare video variables
	    var sitename = jsonObjectLocal.sitename;
	    var sitestring = jsonObjectLocal.sitestring;
	    var videowidth = jsonObjectLocal.videowidth;
	    var videoheight = jsonObjectLocal.videoheight;
	    var videoelement = jsonObjectLocal.videoelement;
	    var videourl = jsonObjectLocal.videourl;
	    var newmimetype = jsonObjectLocal.videomime;
	    var fmt = jsonObjectLocal.videofmt;
	    ...
	    script.innerHTML = "function sendToFLV(){ var method = document.getElementById(\"methodselector\").value; var element = document.createElement(\"FLVDataElement\"); element.setAttribute(\"branch\", \""+aBranch+"\"); element.setAttribute(\"method\", method);  document.documentElement.appendChild(element); var evt = document.createEvent(\"Events\"); evt.initEvent(\"FLVReplaceEvent\", true, false); element.dispatchEvent(evt);}";
	...
	showHideMenus: function () {//show and hide context menus
		...
		if((sourceurl.match(/youtube.*watch.*v\=/) && !sourceurl.match("html5=True")) 
			...
			if(downloadurl !== null){
			    ...
			    copymenuitem.setAttribute('oncommand',"flvideoreplacerListener.flvrcopyToClipboard('"+aSite+"','"+videoid+"','0');");
			...
			if(downloadurl5 !== null){
			    ...
			    copymenuitem.setAttribute('oncommand',"flvideoreplacerListener.flvrcopyToClipboard('"+aSite+"','"+videoid+"','5');");
			    copynewvbox.appendChild(copymenuitem);
			    //append new download menuitem
			    dlmenuitem = document.createElement("menuitem");
			...
			if(downloadurl18 !== null){
			    ...
			    copymenuitem.setAttribute('oncommand',"flvideoreplacerListener.flvrcopyToClipboard('"+aSite+"','"+videoid+"','18');");
			    copynewvbox.appendChild(copymenuitem);
			    //append new download menuitem
			    dlmenuitem = document.createElement("menuitem");
			...
			if(downloadurl34 !== null){
			    ...
			    copymenuitem.setAttribute('oncommand',"flvideoreplacerListener.flvrcopyToClipboard('"+aSite+"','"+videoid+"','34');");
			    copynewvbox.appendChild(copymenuitem);
			    //append new download menuitem
			    dlmenuitem = document.createElement("menuitem");
			...
			if(downloadurl35 !== null){
			    ...
			    copymenuitem.setAttribute('oncommand',"flvideoreplacerListener.flvrcopyToClipboard('"+aSite+"','"+videoid+"','35');");
			    copynewvbox.appendChild(copymenuitem);
			    //append new download menuitem
			    dlmenuitem = document.createElement("menuitem");
			...
			if(downloadurl22 !== null){
			    ...
			    copymenuitem.setAttribute('oncommand',"flvideoreplacerListener.flvrcopyToClipboard('"+aSite+"','"+videoid+"','22');");
			    copynewvbox.appendChild(copymenuitem);
			    //append new download menuitem
			    dlmenuitem = document.createElement("menuitem");
			...
			if(downloadurl37 !== null){
			    ...
			    copymenuitem.setAttribute('oncommand',"flvideoreplacerListener.flvrcopyToClipboard('"+aSite+"','"+videoid+"','37');");
			    copynewvbox.appendChild(copymenuitem);
			    //append new download menuitem
			    dlmenuitem = document.createElement("menuitem");
			...
			if(downloadurl38 !== null){
			    ...
			    copymenuitem.setAttribute('oncommand',"flvideoreplacerListener.flvrcopyToClipboard('"+aSite+"','"+videoid+"','38');");
			    copynewvbox.appendChild(copymenuitem);
			    //append new download menuitem
			    dlmenuitem = document.createElement("menuitem");
